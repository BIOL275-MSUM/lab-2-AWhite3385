...
- Learn how to use the console and source windows, along with writing and running R code.
- Use Github to turn in the lab report and collaborate with others in assignment review.
